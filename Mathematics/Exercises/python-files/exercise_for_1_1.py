...
if __name__ == "__main__":
    print("\n--------------------- Start Question 1 -------------------------\n")
    print("This is Exercise 1.1 Question 1")
    print("---------------------------------\n")
    ...
    print("This is Exercise 1.1 Question 2")
    print("---------------------------------\n")
    ...
    print("This is Exercise 1.1 Question 3")
    c1, c2 = 12849217045006222, 6485880443666222

    print("----------------------------------\n")
    k2, x2, y2 = extended_gcd(c1, c2)

    print(
        f"The private key used by Alice and Bob to decode \
            their messages {c1} and {c2} is k = {k2} \n"
    )
