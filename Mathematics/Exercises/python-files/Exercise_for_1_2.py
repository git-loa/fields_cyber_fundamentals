...
def mod_pow(a: int, e: int, n: int) -> int:
    ...
    pow_a_mod_n = [(a**(2**r))%n for r in range(len(bin_list))] #compute the powers of a modulo n


    prod = 1
    [prod := prod*reduced_mod_n for reduced_mod_n in [i**j for i, j in zip(pow_a_mod_n, bin_list)]]
    return prod%n
...
if __name__ == "__main__":
    ...
    print("\n------ Start of testing exercise 1.2.1\n")
    a, n = 21454362362356235, 34623572343523462537647
    a1, n1 = 7, 24
    a2, n2 = 4, 5
    a3, n3 = 3, 5
    a4, n4 = 4, 8
    ...
    try:
        inverse = mod_inv(a, n)
        print(f"The inverse of {a} modulo {n} is {inverse}")
    except ValueError as e:
        print(e)
    ...
    try:
        inverse2 = mod_inv(a2, n2)
        print(f"The inverse of {a2} modulo {n2} is {inverse2}")
    except ValueError as e:
        print(e)
    ...
    try:
        inverse3 = mod_inv(a3, n3)
        print(f"The inverse of {a3} modulo {n1} is {inverse3}")
    except ValueError as e:
        print(e)
    ...
    try:
        inverse4 = mod_inv(a4, n4)
        print(f"The inverse of {a4} modulo {n4} is {inverse4}")
    except ValueError as e:
        print(e)
